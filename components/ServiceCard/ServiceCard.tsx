...
export default function ServiceCard({ data }: ServiceCardProps): JSX.Element {
  ...
  return (
    <>
      {loading ? (
        <div className="col-span-6 md:col-span-3 xl:col-span-2 overflow-hidden w-full h-full min-h-[7rem] rounded-2xl shadow-lg bg-gray-800 animate-pulse" />
      ) : (
        <li className="col-span-6 md:col-span-3 xl:col-span-2 overflow-hidden w-full h-full min-h-[7rem] rounded-2xl hover:bg-gray-700/50">
