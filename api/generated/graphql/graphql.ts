...
export type AuthorLinkingCollectionsOpinionCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<
    Array<InputMaybe<AuthorLinkingCollectionsOpinionCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};
...
export type OpinionCollection = {
  ...
  items: Array<Maybe<Opinion>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export type OpinionFilter = {
  AND?: InputMaybe<Array<InputMaybe<OpinionFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<OpinionFilter>>>;
...
export type OpinionLinkingCollections = {
  __typename?: 'OpinionLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};

export type OpinionLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type QueryOpinionCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<OpinionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type GetOpinionCollectionQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetOpinionCollectionQuery = {
  __typename?: 'Query';
  opinionCollection?: {
    __typename?: 'OpinionCollection';
    items: Array<{
...
export const GetOpinionCollectionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetOpinionCollection' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'opinionCollection' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
  ...
  GetOpinionCollectionQuery,
  GetOpinionCollectionQueryVariables
>;
