    ...
    <section className="w-full py-20 bg-gray-900">
      <div className="flex flex-col justify-center items-center w-11/12 mx-auto">
        <div className="z-10 relative w-fit">
          <h2 className="heading_2 w-fit font-medium text-white">
            Últimos eventos
          </h2>
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="-z-10 absolute -bottom-4 left-0 h-[2em] w-full fill-lime-600/50"
        ...
        <section className="grid grid-cols-7 justify-center items-center gap-4 mt-16 w-full [&>*:nth-child(1)]:col-span-7 md:[&>*:nth-child(1)]:col-span-3 [&>*:nth-child(2)]:col-span-7 md:[&>*:nth-child(2)]:col-span-2 [&>*:nth-child(3)]:col-span-7 md:[&>*:nth-child(3)]:col-span-2 [&>*:nth-child(4)]:col-span-7 md:[&>*:nth-child(4)]:col-span-2 [&>*:nth-child(5)]:col-span-7 md:[&>*:nth-child(5)]:col-span-2 [&>*:nth-child(6)]:col-span-7 md:[&>*:nth-child(6)]:col-span-3">
